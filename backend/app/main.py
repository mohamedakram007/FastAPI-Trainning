...
async def home():
    try:
        ...
        return {
            "status": "connected", 
            "message": "Backend & MongoDB are working properly!",
            "product_count": count
        }
    except Exception as e:
        print(f"Connection Diagnostic Error: {e}")
        return {
            "status": "error", 
            "message": f"MongoDB Connection Failed: {str(e)}. Please check if your IP is whitelisted in MongoDB Atlas."
        }
